    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                $details_rs = Database::search("SELECT * FROM `academic_officer` INNER JOIN `gender` ON gender.id=academic_officer.gender_id WHERE `email`= '".$email."' ");
                                ...
                                <div class="col-md-5 border-end">
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <h4 class="fw-bold fs-3 text-danger offset-1">Academic Officer<br> Profile Details</h4>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            ...
                                            <div class="col-12 d-grid mt-3">
                                                <button class="btn btn-primary" onclick="academicsupdateProfile();">Update My Profile</button>
                                            </div>
