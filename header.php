            ...
            <div class="row  mb-1">
                    ...
                    <div class=" offset-1 col-12 row ">
                        ...
                        <div class="offset-lg-4 col-lg-4 col-12">
                            <div class="ui buttons">
                                <button class="ui button"><b style="font-size:medium;" onclick="signout();">SignOut</b></button>
                                <div class="or"></div>
                ...
                <div class="col-lg-12 col-12 " style="margin-top:-5px;">
                    <div id="mySidepanel" class="sidepanel">
                        ...
                        <a href="studentprofile.php" class="p-4">My Profile</a>
                        <a href="https://dpeducation.lk/si/" class="p-4">Lecture Videos</a>
                        <a href="#" class="p-4">Assignments</a>
                        <a href="#" class="p-4">Upload Answers</a>
                        <a href="#" class="p-4">Payments</a>
                    </div>
