                        ...
                        <div class="col-12 bg-body rounded mt-4 mb-4">
                            <div class="row g-2">
                                ...
                                <div class="col-md-5 border-end">
                                    <div class="p-3 py-5 bg-secondary rounded">

                                        <div class="d-flex justify-content-between align-items-center mb-3 bg-white rounded bg-opacity-75">
                                            <h4 class="fw-bold fs-3 text-danger offset-1">Student Profile Details</h4>
                                        </div>
                                        ...
                                        <div class="row mt-4  ">
                                            ...
                                            <div class="col-12 d-grid mt-3">
                                                <button class="btn btn-primary text-warning" onclick="updateProfile();">Update My Profile</button>
                                            </div>
...
<?php
    ...
    header("Location:http://localhost/online%20thaksalawa/home.php");
}
