            ...
            <div class="row  mb-1">
                    ...
                    <div class=" offset-1 col-12 row ">
                        ...
                        <div class="offset-lg-4 col-lg-4 col-12">
                            <div class="ui buttons">
                                <button class="ui button"><b style="font-size:medium;" onclick="teachersignout();">SignOut</b></button>
                                <div class="or"></div>
                ...
                <div class="col-lg-12 col-12 " style="margin-top:-5px;">
                    <div id="mySidepanel" class="sidepanel">
                        ...
                        <a href="teacherprofile.php" class="p-4">My Profile</a>
                        <a href="#" class="p-4"> View Submitted Answer Sheets</a>
                        <a href="#" class="p-4"> Add Assignment Marks</a>
                    </div>
