...
<head>
    ...
    <title>Manage Students | Admins | Online Thaksalawa</title>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 bg-dark text-center ">
                <label class="form-label text-white fw-bold fs-1">Manage All Students</label>
            </div>
            ...
            <div class="col-12 mt-3 mb-3 bg-light">
                <div class="row">
                    ...
                    <div class="col-4 col-lg-2 bg-primary py-2">
                        <span class="fs-4 fw-bold text-white">Student Name</span>
                    </div>
                ...
                <div class="col-12 mt-3 mb-3 bg-light">
                    <div class="row">
                        ...
                        <div class="col-2 col-lg-1 bg-white py-2 d-grid">
                            ...
                            ?>
                                <button id="ub<?php echo $selected_data['email']; ?>" class="btn btn-danger" onclick="blockstudent('<?php echo $selected_data['email']; ?>');">Block</button>
                            <?php
                            } else {
                            ?>
                                <button id="ub<?php echo $selected_data['email']; ?>" class="btn btn-success" onclick="blockstudent('<?php echo $selected_data['email']; ?>');">Unblock</button>
                            <?php
